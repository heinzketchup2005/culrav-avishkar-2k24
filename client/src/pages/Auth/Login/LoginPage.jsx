        ...
        <div className="flex items-center justify-center min-h-screen w-full bg-[#FFF2D5] px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col items-center justify-center w-full max-w-lg sm:max-w-md md:max-w-lg lg:max-w-xl p-6 sm:p-8 bg-[#2D2D2D] shadow-lg">
                ...
                <p className="text-center font-sftext text-sm sm:text-base lg:text-lg text-[#FFFAF0] mb-4">
                    ...
                    <Link to="/registration" className="font-medium font-sftext text-[#F54E25] transition-all duration-200 hover:underline">
                        Register Now
                    </Link>
                </p>
                {/* Form */}
                <form onSubmit={handleSubmit(userlogin)} className="w-full space-y-4  sm:space-y-5 lg:space-y-6">
                    <Input
                        placeholder="Enter GSuit Id"
                        type="email"
                    ...
                    <Link to="/forget-password" className="font-medium font-sftext text-sm text-[#F54E25] transition-all duration-200 hover:underline">
                        Forgot password?
                    </Link>
                    ...
                    {submit ? (
                        ...
                        <Button type="submit" className="w-full font-sftext bg-[#F54E25] hover:bg-orange-500 text-lg text-[#FFFAF0] lg:text-xl">
                            Log in
                        </Button>
                    )}
                </form>
